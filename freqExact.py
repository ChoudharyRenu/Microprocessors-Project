...
#this is calculating the frequency of mnemonics in the textfile
#how can we use this to find the frequency of each window(region) in a for loop,so that we can 
#compare  the frequencies of both of the windows and then can decide whether they are exactclone 
# or not
